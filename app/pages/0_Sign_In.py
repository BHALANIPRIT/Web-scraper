...
/* Each social button: proper branded size */
.soc-btn {{
    display: inline-flex;
    align-items: center;
    justify-content: center;
...
with left_col:
    ...
    <div style="background:{t['card']};border:1px solid {t['border']};
      ...
      <!-- Social auth buttons with proper branding logos -->
      <div class="social-row">
        ...
        <!-- Facebook -->
        <a class="soc-btn soc-facebook" title="Continue with Facebook" href="#">
        ...
        <!-- LinkedIn -->
        <a class="soc-btn soc-linkedin" title="Continue with LinkedIn" href="#">
          <svg width="22" height="22" viewBox="0 0 24 24" fill="white">
    ...
    st.markdown(f"""
    <div style="background:{t['card']};border-left:1px solid {t['border']};
         border-right:1px solid {t['border']};padding:0.3rem 2rem 0;text-align:right;">
      <a href="/Forgot_Password" target="_self"
         style="font-size:0.8rem;color:{t['accent']};text-decoration:none;font-weight:500;">
        Forgot password?
      </a>
    </div>
    """, unsafe_allow_html=True)
    ...
    st.markdown(f"""
    <div style="text-align:center;margin-top:0.5rem;font-size:0.75rem;color:{t['muted']};">
